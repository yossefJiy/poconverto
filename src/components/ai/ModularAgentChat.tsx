...
- לזהות נקודות מפתח`,
  ...
  insights: {
    ...
    systemPrompt: `אתה סוכן AI מומחה באיקומרס, לידים ושיווק דיגיטלי.

תפקידך:
- לספק תובנות עסקיות מעמיקות
- לנתח ביצועי קמפיינים ולהציע שיפורים
- לזהות הזדמנויות צמיחה והזדמנויות חדשות
- להמליץ על אסטרטגיות שיווק מבוססות נתונים
- לעזור בכתיבת תוכן שיווקי
- לחפש מידע עדכני על מתחרים ומגמות שוק

יכולות מיוחדות:
- חיפוש אינטרנט למידע עדכני
- ניתוח קמפיינים והמלצות ROI
- יצירת תוכן שיווקי
- אופטימיזציית חנות איקומרס`,
    quickActions: [
      { label: "שפר ROI", prompt: "איך אני יכול לשפר את ה-ROI של הקמפיינים שלי? תן לי המלצות מעשיות" },
      { label: "חפש מתחרים", prompt: "חפש באינטרנט מידע על המתחרים העיקריים בתחום שלי וספק לי ניתוח השוואתי" },
      { label: "נתח קמפיין", prompt: "נתח את הביצועים של הקמפיינים שלי והצע דרכים לשיפור" },
      { label: "תוכן שיווקי", prompt: "כתוב לי פוסט שיווקי מעניין לפייסבוק על המותג/המוצר שלי" },
      { label: "אופטימיזציית המרות", prompt: "תן לי המלצות לאופטימיזציה של חנות האיקומרס שלי לשיפור המרות" },
      { label: "קהלי יעד", prompt: "חפש מידע עדכני על הגדרת קהלי יעד אפקטיביים לפרסום ממומן" },
      { label: "אוטומציות", prompt: "הצע לי אוטומציות שיכולות לחסוך לי זמן בעבודה השיווקית" },
      { label: "הזדמנויות צמיחה", prompt: "בהתבסס על הנתונים שלי, מהן הזדמנויות הצמיחה העיקריות?" },
    ],
  },
};
